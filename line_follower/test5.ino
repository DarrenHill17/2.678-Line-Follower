...
int previousSensor[3]; // Store last sensor state
...
void loop() {
  ...
  int leftSpeed = constrain(-(defaultSpeed + correction), -255, 255);
  int rightSpeed = constrain(defaultSpeed - correction, -255, 255);
